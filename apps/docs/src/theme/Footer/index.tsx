...
/**
 * Get environment-aware URLs for landing and docs
 */
...
export default function FooterWrapper(): ReactNode {
  ...
  const [version, setVersion] = useState('1.3.17')

  useEffect(() => {
    setMounted(true)
    setLandingUrl(getEnvironmentUrls().landing)
  }, [])
      ...
      <div className={styles.content}>
        <div className={styles.grid}>
          ...
          <div className={styles.column}>
            ...
            <ul className={styles.linkList}>
              <li>
                <a href={landingUrl} className={styles.link}>
                  <span className={styles.dot} />
                  Back to Landing
